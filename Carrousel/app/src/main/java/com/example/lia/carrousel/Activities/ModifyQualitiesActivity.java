 ...
 */
public class ModifyQualitiesActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modify_qualities);
    ...
    public void updateInfo(View v){
        ...
        CarrouselManagementSystem.updateInfo(user.getUsername(),User.UserEntry.COLUMN_NAME_NON_SMOCKER,nonSmocker,dbUser);
        CarrouselManagementSystem.updateInfo(user.getUsername(),User.UserEntry.COLUMN_NAME_APTITUDES_CULINAIRES,canCook,dbUser);
