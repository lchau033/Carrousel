...
public class SentDemandsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sent_demands);
        intent = getIntent();
        ...
        if(user.getType().equals(User.UserEntry.GARDIEN_TYPE)){
            demands = CarrouselManagementSystem.getMadeDemands(user.getUsername(), Demande.DemandeEntry.DEMANDE_GARDIEN_TO_PARENT,dbDemande,dbUser);
        } else{
            demands = CarrouselManagementSystem.getMadeDemands(user.getUsername(), Demande.DemandeEntry.DEMANDE_PARENT_TO_GARDIEN,dbDemande,dbUser);
        }
        if(demands == null){
