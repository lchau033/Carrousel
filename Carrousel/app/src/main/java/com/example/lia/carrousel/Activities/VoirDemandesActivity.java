...
public class VoirDemandesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(user.getType().equals(User.UserEntry.GARDIEN_TYPE)){
            demands = CarrouselManagementSystem.getDemands(user.getUsername(), Demande.DemandeEntry.DEMANDE_PARENT_TO_GARDIEN,dbDemande,dbUser);
        } else{
            demands = CarrouselManagementSystem.getDemands(user.getUsername(), Demande.DemandeEntry.DEMANDE_GARDIEN_TO_PARENT,dbDemande,dbUser);
        }
        if(demands == null){
    ...
    private void seeDemand(int position){
        ...
        if(user.getType().equals(User.UserEntry.GARDIEN_TYPE)){
            intent = new Intent(this, SeeDemandActivity.class);
        }else{
            intent = new Intent(this,SeeDemandGardienActivity.class);
        }
