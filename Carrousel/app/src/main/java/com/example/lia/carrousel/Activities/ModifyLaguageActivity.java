 ...
 */
public class ModifyLaguageActivity extends AppCompatActivity {
...
//        boolean[] faculties = user.getFaculties();
//        if(faculties[User.SPEAKS_FRENCH]){
//            french = true;
//        }


       // english = user.equals(User.UserEntry.COLUMN_NAME_SPEAKS_ENGLISH);
...
//        englishCheckbox.setChecked(english);
...
//        spanish = spanishCheckbox.isChecked();
    ...
    public void updateInfo(View v){
        ...
        spanish = spanishCheckbox.isChecked();
            ...
            CarrouselManagementSystem.updateInfo(user.getUsername(),User.UserEntry.COLUMN_NAME_SPEAKS_FRENCH,french,dbUser);
            CarrouselManagementSystem.updateInfo(user.getUsername(),User.UserEntry.COLUMN_NAME_SPEAKS_ENGLISH,english,dbUser);
            CarrouselManagementSystem.updateInfo(user.getUsername(),User.UserEntry.COLUMN_NAME_SPEAKS_SPANISH,spanish,dbUser);
