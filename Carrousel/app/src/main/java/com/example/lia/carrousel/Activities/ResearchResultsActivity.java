...
public class ResearchResultsActivity extends AppCompatActivity {
    ...
    private ArrayList<Map.Entry<String,Object>> columnSearched;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        columnSearched = (ArrayList<Map.Entry<String,Object>>) intent.getSerializableExtra("columnList");
        ...
        potential = CarrouselManagementSystem.ShowParentFeed(user.getUsername(),user.getType(), columnSearched,dbUser,dbDemande,this);
    ...
    private void makeADemand(int position){
        ...
        intent.putExtra("cameFrom", "rechercheAvancee");
        intent.putExtra("columnList",columnSearched);
    ...
    public void alert(String query){
