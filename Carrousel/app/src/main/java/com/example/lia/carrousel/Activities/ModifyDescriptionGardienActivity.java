 ...
 */
public class ModifyDescriptionGardienActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modify_description_gardien);
        intent = getIntent();
        ...
        description1 = user.getDescription();
    ...
    public void updateInfo(View v) {
        ...
        if (descriptionEditText.getText().equals("")) {
            ...
            CarrouselManagementSystem.updateInfo(user.getUsername(), User.UserEntry.COLUMN_NAME_AGE, ageNumberPicker.getValue(), dbUser);
            CarrouselManagementSystem.updateInfo(user.getUsername(), User.UserEntry.COLUMN_NAME_DESCRIPTION, descriptionEditText.getText().toString(), dbUser);
