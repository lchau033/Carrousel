...
import com.example.lia.carrousel.Activities.Register.RegisterPasswordActivity;
...
/**
 * Created by Daniella on 16-07-18.
 */
public class ModifyNamesActivity extends AppCompatActivity {
   ...
   String TITLES[] = {"Page principale","Recherche avancée","Voir demandes reçues","Voir demandes confirmées","Voir demandes effectuées","Changer votre profil","Déconnexion","Aide"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modify_names);
    ...
    public void updateInfo(View v){
        ...
        if(prenomEditText.getText().toString().equals("") || nomEditText.getText().toString().equals("") || emailEditText.getText().toString().equals("") || !isEmailValid(emailEditText.getText().toString()) ||passwordEditText.getText().toString().equals("") || confirmPasswordEditText.getText().toString().equals("")){
            ...
            CarrouselManagementSystem.updateInfo(user.getUsername(),User.UserEntry.COLUMN_NAME_PRENOM,prenomEditText.getText().toString(),dbUser);
            CarrouselManagementSystem.updateInfo(user.getUsername(),User.UserEntry.COLUMN_NAME_NOM,nomEditText.getText().toString(),dbUser);
            CarrouselManagementSystem.updateInfo(user.getUsername(),User.UserEntry.COLUMN_NAME_USERNAME,emailEditText.getText().toString(),dbUser);
            CarrouselManagementSystem.updateInfo(user.getUsername(),User.UserEntry.COLUMN_NAME_PASSWORD,passwordEditText.getText().toString(),dbUser);
