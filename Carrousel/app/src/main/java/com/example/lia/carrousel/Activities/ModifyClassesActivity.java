 ...
 */
public class ModifyClassesActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modify_classes);
        intent = getIntent();
    ...
    public void updateInfo(View v) {
        ...
        CarrouselManagementSystem.updateInfo(user.getUsername(),User.UserEntry.COLUMN_NAME_HELP_WITH_MATH,mathCheckbox.isChecked(),dbUser);
        CarrouselManagementSystem.updateInfo(user.getUsername(),User.UserEntry.COLUMN_NAME_HELP_WITH_LANGUAGE_CLASSES,languesCheckbox.isChecked(),dbUser);
        CarrouselManagementSystem.updateInfo(user.getUsername(),User.UserEntry.COLUMN_NAME_HELP_WITH_SCIENCE,sciencesCheckbox.isChecked(),dbUser);
