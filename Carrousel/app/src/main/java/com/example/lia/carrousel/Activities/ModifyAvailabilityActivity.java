 ...
 */
public class ModifyAvailabilityActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modify_availability);
        intent = getIntent();
    ...
    public void updateInfo(View v){
        ...
        CarrouselManagementSystem.updateInfo(user.getUsername(),User.UserEntry.COLUMN_NAME_AVAILABLE_MONDAY,monday,dbUser);
        CarrouselManagementSystem.updateInfo(user.getUsername(),User.UserEntry.COLUMN_NAME_AVAILABLE_TUESDAY,tuesday,dbUser);
        CarrouselManagementSystem.updateInfo(user.getUsername(),User.UserEntry.COLUMN_NAME_AVAILABLE_WEDNESDAY,wednesday,dbUser);
        CarrouselManagementSystem.updateInfo(user.getUsername(),User.UserEntry.COLUMN_NAME_AVAILABLE_THURSDAY,thursday,dbUser);
        CarrouselManagementSystem.updateInfo(user.getUsername(),User.UserEntry.COLUMN_NAME_AVAILABLE_FRIDAY,friday,dbUser);
        CarrouselManagementSystem.updateInfo(user.getUsername(),User.UserEntry.COLUMN_NAME_AVAILABLE_SATURDAY,saturday,dbUser);
        CarrouselManagementSystem.updateInfo(user.getUsername(),User.UserEntry.COLUMN_NAME_AVAILABLE_SUNDAY,sunday,dbUser);
